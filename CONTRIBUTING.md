...
Thank you for taking the time to look at Synheart Core (Kotlin). This document explains
...
1. Search [existing issues](https://github.com/synheart-ai/synheart-core-kotlin-edge/issues) to avoid
   duplicates.
