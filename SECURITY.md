...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-core-kotlin-edge/security/advisories/new).
...
This policy covers the `synheart-core-edge` SDK published from this repository. Issues
